...
// Validate validates this story list
func (m *StoryList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StoryList) validateItems(formats strfmt.Registry) error {
...
func (m *StoryList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StoryList) UnmarshalBinary(b []byte) error {
	var res StoryList
