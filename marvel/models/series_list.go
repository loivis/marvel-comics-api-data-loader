...
// Validate validates this series list
func (m *SeriesList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SeriesList) validateItems(formats strfmt.Registry) error {
...
func (m *SeriesList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SeriesList) UnmarshalBinary(b []byte) error {
	var res SeriesList
