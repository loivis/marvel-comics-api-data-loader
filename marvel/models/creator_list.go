...
// Validate validates this creator list
func (m *CreatorList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreatorList) validateItems(formats strfmt.Registry) error {
...
func (m *CreatorList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreatorList) UnmarshalBinary(b []byte) error {
	var res CreatorList
